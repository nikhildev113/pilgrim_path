...
System.out.println("_______________________________________________________________________________________________________________________"); System.out.println();System.out.println();
...
while(Point1 < d || Point2< d) { if(d==1 && first_player==2){break;} 
                                 System.out.println("Player 1 apki Turn Hai."); input = robotic_play(d);            //currently 2 robot version on selection with robot.
     ...
     while(input==(d*d+1)*10+1 || input==(d*d+1)*10+2 || (input<=0 || input>d*d) || repeat.contains(input)) {
        ...
        if(repeat.contains(input)) {System.out.println("This is already played. ReEnter:- ");}
           input = robotic_play(d);}                                 //currently 2 robot version on selection with robot.
repeat.push(input);
	...
	//telly; 
		  ...
		  if(Point2>=d) {
			System.out.println("Sorry but you loose and Player2 win by your chance. (You are also gonna be a Winner in future)");  
			System.out.println("But Celebrate for Player2 winner");
			printBIN(Player2);System.out.println("Ohh ho kya baat hai. Player 2 win with" +Point2+" matlab jeet gaya hai and unfortunately Player 1 loose");
 ...
 // player 2 is playing
	...
	//telly
      	...
      	Point1 = pointx(Player1, d)+pointy(Player1, d)+pointz(Player1 ,d);
		  if(Point1>=d) {
			System.out.println("Sorry but you loose and Player1 win by your chance. (You are also gonna be a Winner in future)");  
...
static int[][] BBox(int d /*Dimenssion of BINGO box*/){
